...
# Check for recent data written to the database query table, where recent
# is anything within the last e.g. RECENT_INTERVAL_SECONDS.
...
# type one in the Requests table. Finally, return the dict-formatted data.
